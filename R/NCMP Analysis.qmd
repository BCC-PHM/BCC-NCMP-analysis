...
load("fingertips_data_3_years_combined.rda")
```
...
# Wards
birmingham_wards <- read_sf("C:/Users/bccaengs/OneDrive - Birmingham City Council/Documents/Work/Useful datasets/Shape files/boundaries-wards-2022-birmingham.geojson")

# Constituencies
birmingham_con <- read_sf("C:/Users/bccaengs/OneDrive - Birmingham City Council/Documents/Work/Useful datasets/Shape files/boundaries-constituencies24-bsol.geojson") |> 
  filter(local_authority_name == "Birmingham") |> 
  rename(PCON24CD = pcon24cd,
         PCON24NM = pcon24nm) |> 
  mutate(PCON24NM = str_replace(PCON24NM, "Birmingham ", ""))

birmingham_locality <- read_sf("C:/Users/bccaengs/OneDrive - Birmingham City Council/Documents/Work/Useful datasets/Shape files/boundaries-locality-bsol.geojson") |> 
